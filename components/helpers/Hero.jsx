...
const Hero = ({H1 , H2 , H3 , Img , nameServices , Imgintro , altCover , titleServices  }) => {
  return (
    ...
    <div className="container"> <Navbar1 /> </div>
      <div className="coverIntro" data-aos="zoom-in"  > <Image src={Imgintro} alt=""  /></div>
    <div className="home">
          <div className="container">
              <div className="boxImg " data-aos="zoom-in-left" data-aos-delay="400"  >  <Image   src={Img} alt={nameServices} title={titleServices} loading="lazy" /> </div>
